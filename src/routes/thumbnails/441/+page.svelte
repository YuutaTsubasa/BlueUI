...
<VideoThumbnail 
  ...
  backgroundImageUrl="/images/videos/441/background.png"
  ...
  volumeNumber=441>
  <span slot="subtitle">體驗 Game Gear 的塔爾斯系列遊戲</span>
  <span slot="title">Sonic Origins Plus <span class="sub-font">#5</span></span>
</VideoThumbnail>